# ============================================================================
# Package Module Integration Tests
# ============================================================================
#
# Tests for the pkg module functions
...
Describe "State Management" {
    ...
    It "should get package state" {
        ...
        $state.files | Should -Contain "file1"
    }
...
Describe "Extraction Rules" {
    ...
    It "should extract env vars from rules" {
        ...
        $envs.Keys | Should -Contain "BIN_PATH"
        $envs.Keys | Should -Contain "LIB_PATH"
